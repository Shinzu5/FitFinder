  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <section id="solutions" className="px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 p-8 md:p-12">
            <div className="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[#FFD700]/10 blur-3xl" />
            <div className="relative grid items-center gap-12 md:grid-cols-2">
              <div>
                <span className="mb-4 inline-block rounded-full border border-[#FFD700]/30 bg-[#FFD700]/10 px-3 py-1 text-xs font-medium text-[#FFD700]">
                  For Gym Owners
                </span>
              ...
              <div className="flex justify-center">
                <div className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold">Mobile Coach</p>
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-zinc-400">
              Whether you run a gym, coach clients, or manage operations — Fit Finder
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {PRICING.map((plan) => (
              ...
              >
                {plan.popular && (
                  <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-[#FFD700] px-3 py-0.5 text-xs font-semibold text-black">
                    Most Popular
                  </span>
                )}
          ...
          <div className="grid gap-12 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-zinc-500">
                ...
                <li><a href="#solutions" className="transition hover:text-white">AI Coach</a></li>
              </ul>
            </div>
            <div>
              <h4 className="mb-4 text-sm font-semibold">Contact Support</h4>
              <p className="text-sm text-zinc-500">support@fitfinder.com</p>
            </div>
            <div>
