  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
      <section className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
        <p className="text-sm uppercase tracking-[0.3em] text-[#FACC15]">Admin workspace</p>
        <h2 className="mt-3 text-2xl font-semibold">Platform administration</h2>
        <p className="mt-3 text-sm text-zinc-400">Monitor ecosystems, users, and growth signals with a secure admin console experience.</p>
      </section>
      <section className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
